...
describe('platformInstrumentation', () => {
    ...
    describe('handler request span', () => {
        it('starts a span named "request" with http.request.method and url.path attributes', async () => {
    ...
    describe('route loader span', () => {
        ...
        it('starts a span named "loader" with route attributes only (HTTP attrs on parent request span)', async () => {
    ...
    describe('route action span', () => {
        ...
        it('starts a span named "action" with route attributes only (HTTP attrs on parent request span)', async () => {
    ...
    describe('route middleware span', () => {
        ...
        it('starts a span named "middleware" with route attributes only (HTTP attrs on parent request span)', async () => {
