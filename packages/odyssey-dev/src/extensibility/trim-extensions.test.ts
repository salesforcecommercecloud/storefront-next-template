...
let mockedExtensionConfig: Record<string, {name: string, description: string, dependencies: string[]}> = {
    extensions: {
        SFDC_EXT_featureA: {
            name: 'Feature A',
...
describe('trim-extensions without config', () => {
    ...
    it('returns early if no plugins is defined', () => {
        ...
        trimExtensions('/mock/dir', {}, {extensions: {}})
...
describe('trim-extensions', () => {
    ...
    it('fails when block marker is not closed', () => {
        ...
        expect(() => trimExtensions('/mock/dir', {SFDC_EXT_featureA: false}, mockedExtensionConfig)).toThrow(
    ...
    it('removes entire file when marked by @sfdc-extension-file marker', () => {
        ...
        trimExtensions('/mock/dir', {SFDC_EXT_featureA: false, SFDC_EXT_featureB: true}, mockedExtensionConfig)
