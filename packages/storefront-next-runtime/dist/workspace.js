...
*/
function isWorkspaceEnvironment() {
	if (typeof window !== "undefined") return false;
	return !!process.env.SFW_FALCON_INSTANCE || !!process.env.SFW_SERVICE_INSTANCE || !!process.env.SFW_LOCATION;
}
/**
...
*/
function getWorkspaceSlasOrgId(orgId) {
	return orgId.replace(/^f_ecom_/, "");
}

//#endregion
export { getWorkspaceSlasOrgId, isWorkspaceEnvironment };
