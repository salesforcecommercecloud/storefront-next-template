...
declare const siteContext: react_router7.RouterContext<SiteContext | null>;
/**
...
declare function getSiteContextCookies(context: Readonly<RouterContextProvider>): {
  siteCookie: react_router7.Cookie;
  localeCookie: react_router7.Cookie;
  currencyCookie: react_router7.Cookie;
} | null;
/**
