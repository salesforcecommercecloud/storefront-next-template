...
function isHardcodedColor(className) {
    ...
    const allowedPatterns = [
        /^(bg|text|border|ring|shadow|divide|placeholder|accent|caret|decoration|outline|fill|stroke)-(background|foreground|card|card-foreground|popover|popover-foreground|primary|primary-foreground|secondary|secondary-foreground|muted|muted-foreground|accent|accent-foreground|destructive|destructive-foreground|border|input|ring|chart-1|chart-2|chart-3|chart-4|chart-5|sidebar|sidebar-foreground|sidebar-primary|sidebar-primary-foreground|sidebar-accent|sidebar-accent-foreground|sidebar-border|sidebar-ring|success|success-foreground|info|info-foreground|warning|warning-foreground|separator|separator-foreground|rating|rating-foreground|paypal-gold|venmo-blue|brand-primary|brand-primary-hover|order-status-new|order-status-new-foreground|order-status-warning|order-status-warning-foreground|order-status-completed|order-status-completed-foreground|order-status-cancelled|order-status-cancelled-foreground|order-border|order-pickup|order-pickup-border)$/,
