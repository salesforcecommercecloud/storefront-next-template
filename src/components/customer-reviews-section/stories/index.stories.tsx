...
import { CustomerReviewsSection } from '..';

const mockProduct = { id: 'storybook-product', name: 'Storybook Product' };

function CustomerReviewsSectionWrapper(): ReactElement {
...
const meta: Meta<typeof CustomerReviewsSectionWrapper> = {
    title: 'Components/CustomerReviewsSection/Index',
    component: CustomerReviewsSectionWrapper,
    tags: ['autodocs'],
    parameters: {
        layout: 'padded',
        docs: {
            description: {
                component:
                    'Customer Reviews accordion with AI summary, star distribution, and lazy-loaded review cards.',
            },
        },
    },
};
...
type Story = StoryObj<typeof CustomerReviewsSectionWrapper>;
