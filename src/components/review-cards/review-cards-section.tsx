...
const REVIEW_SORT_OPTIONS = [
    { value: 'most-recent', labelKey: 'sortMostRecent' as const },
    { value: 'highest-rated', labelKey: 'sortHighestRated' as const },
    { value: 'lowest-rated', labelKey: 'sortLowestRated' as const },
    { value: 'most-helpful', labelKey: 'sortMostHelpful' as const },
] as const;
