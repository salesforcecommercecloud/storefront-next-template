...
import * as ResetPasswordFormStories from './index.stories';
import { render, cleanup } from '@testing-library/react';

const composed = composeStories(ResetPasswordFormStories);

afterEach(() => {
    cleanup();
});

describe('ResetPasswordForm stories snapshot', () => {
