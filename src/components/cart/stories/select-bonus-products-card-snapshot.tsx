...
import * as SelectBonusProductsCardStories from './select-bonus-products-card.stories';
import { render, cleanup } from '@testing-library/react';

const composed = composeStories(SelectBonusProductsCardStories);

afterEach(() => {
    cleanup();
});

describe('SelectBonusProductsCard stories snapshot', () => {
