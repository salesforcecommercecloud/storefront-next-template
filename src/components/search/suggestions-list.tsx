            ...
            <div className="-mx-4">
                {suggestions.map((suggestion) => (
                    <button
                        ...
                        className="w-full flex justify-start items-center px-4 py-2 hover:bg-gray-50 transition-colors text-base mt-0">
                        <div className="flex items-center">
                            <div className="w-10 h-10 mr-4 rounded-full bg-transparent flex items-center justify-center overflow-hidden shrink-0">
                                {suggestion.image ? (
                                    <DynamicImage
