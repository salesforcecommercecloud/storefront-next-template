...
import * as DeferredWishlistButtonStories from './deferred-wishlist-button.stories';
import { render, cleanup } from '@testing-library/react';

const composed = composeStories(DeferredWishlistButtonStories);

afterEach(() => {
    cleanup();
});

describe('DeferredWishlistButton stories snapshot', () => {
