...
import * as ShippingAddressStories from './shipping-address.stories';
import { render, cleanup } from '@testing-library/react';

const composed = composeStories(ShippingAddressStories);

afterEach(() => {
    cleanup();
});

describe('ShippingAddress stories snapshot', () => {
