...
import bopisTranslations from '@/extensions/bopis/locales/en/translations.json';
import storeLocatorTranslations from '@/extensions/store-locator/locales/en/translations.json';
