...
import bnplTranslations from '@/extensions/bnpl/locales/de-DE/translations.json';
import bopisTranslations from '@/extensions/bopis/locales/de-DE/translations.json';
import customerPreferencesTranslations from '@/extensions/customer-preferences/locales/de-DE/translations.json';
import multishipTranslations from '@/extensions/multiship/locales/de-DE/translations.json';
import productContentTranslations from '@/extensions/product-content/locales/de-DE/translations.json';
import storeLocatorTranslations from '@/extensions/store-locator/locales/de-DE/translations.json';
