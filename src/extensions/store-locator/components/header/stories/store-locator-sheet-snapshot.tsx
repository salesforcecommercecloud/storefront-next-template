...
import * as StoreLocatorSheetStories from './store-locator-sheet.stories';
import { render, cleanup } from '@testing-library/react';
import { StoryTestWrapper } from '../../../../../../.storybook/test-wrapper';

const composed = composeStories(StoreLocatorSheetStories);

afterEach(() => {
    cleanup();
});

describe('StoreLocatorSheet stories snapshot', () => {
