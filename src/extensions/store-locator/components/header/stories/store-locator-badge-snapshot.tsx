...
import * as StoreLocatorBadgeStories from './store-locator-badge.stories';
import { render, cleanup } from '@testing-library/react';
import { StoryTestWrapper } from '../../../../../../.storybook/test-wrapper';

const composed = composeStories(StoreLocatorBadgeStories);

afterEach(() => {
    cleanup();
});

describe('StoreLocatorBadge stories snapshot', () => {
